...
/*         REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 0, 0.0))); */
/*       } */
/*       /1* THEN(".should move z and y axis to the next position (5x5x5)") { *1/ */
/*       /1*   vec3 puzzleSize = vec3(5,5,5); *1/ */
/*       /1*   Piece piece(vec3(0, 0, 0), puzzleSize); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 4, 0.0))); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 4, -4))); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 0, -4))); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 0, 0.0))); *1/ */
/*       /1* } *1/ */
/*       /1* THEN("should move z and y axis to the next position (2x2x2)") { *1/ */
/*       /1*   vec3 puzzleSize = vec3(4,4,4); *1/ */
/*       /1*   Piece piece(vec3(0, 0, 0), puzzleSize); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 3, 0.0))); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 3, -3))); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 0, -3))); *1/ */

/*       /1*   piece.rotate(); *1/ */
/*       /1*   REQUIRE(glm::to_string(piece.position) == glm::to_string(vec3(0, 0, 0.0))); *1/ */
/*       /1* } *1/ */
/*       /1* THEN("should move z and y axis to the next position (4x4x4)") { *1/ */
/*       /1*   vec3 puzzleSize = vec3(4,4,4); *1/ */
/*       /1*   Piece piece(vec3(0, 0, 0), puzzleSize); *1/ */
